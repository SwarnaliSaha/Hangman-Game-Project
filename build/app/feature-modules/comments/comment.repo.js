...
const updateOne = (filter, update) => __awaiter(void 0, void 0, void 0, function* () {
    return comment_schema_1.CommentModel.updateOne(filter, update);
});
const findOne = (filters) => __awaiter(void 0, void 0, void 0, function* () {
    return yield comment_schema_1.CommentModel.findOne(Object.assign(Object.assign({}, filters), { isDeleted: false }));
});
