...
const mderatorAccess = (userId) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const user = yield findUser({ _id: new mongoose_1.Types.ObjectId(userId) });
    const findIndex = (_a = user.role) === null || _a === void 0 ? void 0 : _a.findIndex(ele => ele.toString() === role_type_1.Roles.moderator.toString());
    if (findIndex == -1) {
        const updateUser = yield user_repo_1.default.updateOne({ _id: new mongoose_1.Types.ObjectId(userId) }, { $push: {
                role: role_type_1.Roles.moderator
            }
        });
        return user_response_1.user_responses.moderator_access_given;
    }
    return user_response_1.user_responses.moderator_access_not_given;
});
exports.default = {
    createUser,
    updateUser,
